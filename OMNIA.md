...
| Concern | Files |
|---|---|
| Mark + wordmark | `apps/frontend/src/components/ui/omnia-rings.tsx` (the paths of `brand/omnia-mark.svg` in the platform repo, verbatim — OMN-258), `components/new-layout/logo.tsx`, `components/ui/logo-text.component.tsx`, `public/omnia.svg`, `public/favicon.{ico,png}` |
